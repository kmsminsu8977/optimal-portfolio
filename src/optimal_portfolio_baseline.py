...
PROJECT = {"analysis_type": "optimal_portfolio", "category": "Portfolio Optimization & Allocation", "columns": ["asset", "ret_1", "ret_2", "ret_3", "ret_4", "ret_5", "ret_6"], "methods": ["월별 합성 수익률에서 기대수익률과 공분산을 추정한다.", "10% 단위 grid search로 long-only, full-investment 제약을 만족하는 가중치를 찾는다.", "실제 투자 추천이 아니라 최적화 절차를 설명하는 기준 구현이다."], "module_name": "optimal_portfolio_baseline", "objective": "표본 수익률에서 평균-분산 기준의 단순 최적 가중치를 찾는다.", "question": "제약조건이 있는 long-only 포트폴리오에서 Sharpe ratio가 가장 높은 가중치 조합은 무엇인가?", "rows": [["GLOBAL_EQUITY", 0.021, -0.012, 0.018, 0.006, -0.009, 0.016], ["KOREA_EQUITY", 0.018, -0.015, 0.022, -0.002, -0.006, 0.02], ["US_BOND", -0.004, 0.008, 0.003, 0.006, 0.004, -0.001], ["ALT_RISK_PREMIA", 0.01, 0.003, -0.005, 0.012, -0.002, 0.008]], "sample_name": "asset_return_panel.csv", "title_en": "Optimal Portfolio", "title_ko": "최적 포트폴리오"}
